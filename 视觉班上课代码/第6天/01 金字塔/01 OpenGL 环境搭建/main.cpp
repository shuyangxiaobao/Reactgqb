...
GLGeometryTransform    transformPipeline;  //变换管道 用来管理投影和模型矩阵
M3DMatrix44f        shadowMatrix;  //3D矩阵
...
bool LoadTGATexture(const char *szFileName, GLenum minFilter, GLenum magFilter, GLenum wrapMode)
{
    ...
    //参数2:针对GL_UNPACK_ALIGNMENT 设置的值
         //1 (byte排列)、2(排列为偶数byte的 )、4(字word排 )、8(行从双字节边界开始)
...
void RenderScene(void)
{
    ...
    /**点光源着色器
     参数1：GLT_SHADER_TEXTURE_POINT_LIGHT_DIFF（着色器标签） 点光源矩阵
     参数2：模型视图矩阵
     参数3：投影矩阵
     参数4：视点坐标系中的光源位置
     参数5：基本漫反射颜色
